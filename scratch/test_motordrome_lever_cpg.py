...
def main():
    ...
    print(f"=== Motordrome Lever CPG Simulation ===")

    run_dir = make_run_dir(build_run_id("motordrome", "lever_cpg"))
    out_video = Path(run_dir) / "renders" / "motordrome_lever_cpg.mp4"
    ...
    dst = Path("/home/azureuser/.gemini/antigravity-ide/brain/cae66589-5edc-46dd-9306-d193640ffe8c/motordrome_lever_cpg.mp4")
    import shutil
