...
Usage (from the repo root):
    python scripts/heuristic/random_agent.py                # 1 episode, video
    python scripts/heuristic/random_agent.py --episodes 3 --no-video
"""
...
def main():
    args = script_config("random_agent", passthrough=True)
    ...
    run_dir = make_run_dir(build_run_id("random_agent", tag=kind_tag))
