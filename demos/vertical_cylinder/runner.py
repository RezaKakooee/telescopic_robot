...
Usage:
    python demos/vertical_cylinder/runner.py --video
    python demos/vertical_cylinder/runner.py --pitch 28 --target-z 3.5
"""
...
from skills.low_level.climbing import cylinder_spiral_climb
...
if __name__ == "__main__":
    args = demo_config("vertical_cylinder").knobs
