...
Run::
    ...
    python demos/bowl/runner.py --seconds 75 --video
    python demos/bowl/runner.py --seconds 75 \
...
:func:`~skills.low_level.locomotion.stop` to get rid of the rest.

The physics is in :mod:`skills.low_level.bowl_riding`; this file only drives it and
...
from skills.low_level.locomotion import stop as stop_skill
from skills.low_level.bowl_riding import (
