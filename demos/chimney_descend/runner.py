...
Usage:
    python demos/chimney_descend/runner.py --mode servo --v-target -0.50 --video
    python demos/chimney_descend/runner.py --mode step --video
"""
...
from skills.low_level.climbing import chimney_friction_servo, chimney_step_down
...
if __name__ == "__main__":
    args = demo_config("chimney_descend").knobs
