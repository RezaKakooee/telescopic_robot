...
Every jump's parameters come from `skills/mid_level/jump_planner.py`, computed from that
...
rather than driving into the box.
    ...
    python demos/platforms/runner.py --video
"""
...
from skills.mid_level.jump_planner import plan_jump
...
def main():
    args = demo_config("platforms").knobs
